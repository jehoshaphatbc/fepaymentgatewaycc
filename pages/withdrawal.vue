    ...
    <div>
        ...
        <section class="bg-white py-8 antialiased dark:bg-gray-900 flex items-center h-screen justify-center">
            <div class="max-w-7xl w-full">
                <h2 class="text-center text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Withdrawal</h2>
...
const submitForm = handleSubmit(async (values) => {
    ...
    try {
        ...
        const response = await axios.post(config.public.BACKEND_API+'/withdrawal', {
